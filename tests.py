...
class TestCase(unittest.TestCase):
    ...
    def create_vars(self):
        ...
        self.timeslots_list = [TimeSlot(day_of_week=0, 
                start_time=time(8,0), end_time=time(18,30)),
        ...
        self.desc = """Lorem ipsum dolor sit amet, consectetur adipiscing elit. 
            ...
            consequat. Mauris laoreet enim ipsum. Cum sociis natoque penatibus et 
            magnis dis parturient montes, nascetur ridiculus mus. Nulla facilisi. 
            In et dui ante. Morbi elementum dolor ligula, et mollis magna interdum 
            non. Mauris ligula mi, mattis at ex ut, pellentesque porttitor elit. 
            Integer volutpat elementum tristique. Ut interdum, mauris a feugiat 
            euismod, tortor."""
        ...
        self.u2 = User(username = 'steve', password = 'p@$$w0rd', 
            email = 'steve@gmail.com', first_name = 'Steve', last_name = 'Smith', 
            roles = [Role(name = 'User')])
    ...
    def test_create_valid_resource(self):
        ...
        r1 = FoodResource(name='Test Food Resource 1', address=self.a1, 
            phone='1234567898',timeslots=self.timeslots_list,
            description=self.desc,location_type='FARMERS_MARKET')
        db.session.add(r1)
        db.session.commit()
        assert len(FoodResource.query
            .filter_by(name = 'Test Food Resource 1').all()) == 1
        assert len(FoodResource.query
            .filter_by(address = self.a1).all()) == 1
